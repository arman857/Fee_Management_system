            ...
            <table class="table caption-top">
                ...
                <tbody>
                  ...
                  {{-- </td>
                    <td>
                      @if($data->DOB == "fill")
                      <span class="badge badge-success text-danger"><i>fill</i></span>
                    @else
                    <span class="badge badge-warning text-secondary"><i>Pending</i></span>
                    @endif
                    </td> --}}
                  </tr>
                @endforeach
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <div class="form-group col-6">
                        ...
                        <input type="number" class="form-control text-center" name="Mobile_Number" placeholder=""required>
                      </div>
                </div>

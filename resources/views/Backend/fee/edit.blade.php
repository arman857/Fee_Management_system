...
<label for="exampleFormControlInput1" class="text-info"><i>Student Name</i></label>
  <input type="text" class="form-control text-center" value="{{$fee->student_name}}"  name="student_name" placeholder=
     ...
     <div class="row">
      <div class="form-group col-6">
        <label for="exampleFormControlInput1" class="text-info"><i>Amount</i></label>
          <input type="number" class="form-control  text-center" value="{{$fee->amount}}" name="amount" placeholder=
          "Enter your amount" required>
            </div>
              <div class="form-group col-6">
                <label for="exampleFormControlInput1" class="text-info"><i>Payment Method</i></label>
                  <input type="text" class="form-control text-center" value="{{$fee->payment_method}}" name=
                  "payment_method" placeholder="Payment Method" required>
                    </div>
                      </div>
<div class="row">
  <div class="form-group col-6">
   <label for="exampleFormControlInput1" class="text-info"><i>Status</i></label>
    <input type="text" class="form-control  text-center" value="{{$fee->status}}" name="status" placeholder="Status"
     required>
     </div>
      <div class="form-group col-6">
       <label for="exampleFormControlInput1" class="text-info"><i>Comment</i></label>
         <input type="text" class="form-control text-center" value="{{$fee->comment}}" name="comment" placeholder=
